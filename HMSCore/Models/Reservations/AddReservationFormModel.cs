...
namespace HotelManagementSystem.Models.Reservations
{
    public class AddReservationFormModel : IValidatableObject
    {
        ...
        [MaxLength(50, ErrorMessage = Areas.Admin.Validators.Messages.ValidatorConstants.maxLength)]
        [MinLength(2, ErrorMessage = Areas.Admin.Validators.Messages.ValidatorConstants.minLength)]
