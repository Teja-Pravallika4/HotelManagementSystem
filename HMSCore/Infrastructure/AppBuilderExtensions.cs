...
namespace HotelManagementSystem.Infrastructure
{
    public static class AppBuilderExtensions
    {
        ...
        public static void SeedGuests(HotelManagementDbContext db)
        {
            ...
            var guests = new[]
            {
                new Guest { FirstName = "Sai", LastName = "Sumanth", Address = "Kurnool", City = db.Cities.OrderBy(c => c.Name).FirstOrDefault(c => c.Name == "Sanju"),
                Created = DateTime.UtcNow, Email = "ssa@abv.bg", IdentityCardId = "45677567", Phone="64585674876", Rank = db.Ranks.OrderBy(r => r.Name).FirstOrDefault(r => r.Name == "Regular")},

                new Guest { FirstName = "Ganesh", LastName = "Rachewad", Address = "Chichund", City = db.Cities.OrderBy(c => c.Name).FirstOrDefault(c => c.Name == "Sanju"),
